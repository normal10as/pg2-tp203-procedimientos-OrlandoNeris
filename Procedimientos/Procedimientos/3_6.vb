Module _3_6
    ...
    '.Elaborar un algoritmo que lea un número N, 
    'que imprima la sumatoria de los cuadrados de los enteros entre 1 y N. 
    'Utilizar un método para el cálculo de la sumatoria vía parámetro por referencia. 
    'Utilizar un método para validar los valores ingresados sean enteros positivos, si no
